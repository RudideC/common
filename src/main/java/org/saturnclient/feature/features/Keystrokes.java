...
public class Keystrokes extends Feature implements HudFeature {
    ...
    private static final FeatureLayout dimensions = new FeatureLayout(78, 54);
    ...
    public Keystrokes(KeystrokesInterface minecraft) {
        super(new FeatureDetails("Keystrokes", "keystrokes")
