...
public class ArmorDisplay extends Feature implements HudFeature {

    private static Property<Boolean> enabled = Property.bool(false);
    private static FeatureLayout dimensions = new FeatureLayout(40, 75);
    ...
    public ArmorDisplay(ArmorDisplayInterface minecraft) {
        super(new FeatureDetails("Armor Display", "armor")
